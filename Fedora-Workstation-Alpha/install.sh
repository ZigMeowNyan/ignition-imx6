#!/bin/bash
set -e
echo "Downloading and flashing Fedora 26"
...
curl -L -k http://mirror.sjc02.svwh.net/fedora/development/26/Workstation/armhfp/images/Fedora-Workstation-armhfp-26-20170512.n.0-sda.raw.xz --progress | unxz | dd of=/dev/mmcblk0 bs=1M conv=fsync

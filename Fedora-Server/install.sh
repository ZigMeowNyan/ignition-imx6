...
curl -L -k http://mirror.sjc02.svwh.net/fedora/releases/25/Server/armhfp/images/Fedora-Server-armhfp-25-1.3-sda.raw.xz --progress | unxz | dd of=/dev/mmcblk0 bs=1M conv=fsync
